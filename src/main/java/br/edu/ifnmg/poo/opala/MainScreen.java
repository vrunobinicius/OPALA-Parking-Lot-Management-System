...
//                }Ï
    ...
    private void initComponents() {
        ...
        JLabel txtFeeLabel = new JLabel();
        JPanel estacionamentojPanel = new JPanel();
        JScrollPane scrPaneLista = new JScrollPane();
        tableDriver = new javax.swing.JTable();
        JLabel lblEstacionamento = new JLabel();
        JPanel pnlPayment = new JPanel();
        JLabel lblCaixa = new JLabel();
        JPanel jPanel1 = new JPanel();
        JPanel valoresBotoes = new JPanel();
        JButton btnTotal = new JButton();
        JButton btnPix = new JButton();
        JButton btnDinheiro = new JButton();
        JButton btnCartao = new JButton();
        JScrollPane scrPnLista = new JScrollPane();
        JTable tblLista = new JTable();
        JPanel pnlRelatorio = new JPanel();
        JButton btnBaixarMensal = new JButton();
        JButton btnBaixarDiario = new JButton();
        JLabel lblRelatorio = new JLabel();
        JPanel pnlSubscriber = new JPanel();
        JLabel lblMensalista = new JLabel();
        JScrollPane scrPaneLista1 = new JScrollPane();
        JTable jTable2 = new JTable();
        JPanel pnlSearchIcon = new JPanel();
        JLabel lblSearchIcon = new JLabel();
        JTextField txtSearchSubscriber = new JTextField();
        JButton btnAddSubscriber = new JButton();
        JPanel pnlUser = new JPanel();
        JLabel lblUser = new JLabel();
        JScrollPane scrPaneLista2 = new JScrollPane();
        JTable jTable3 = new JTable();
        JPanel pnlSearchIconUser = new JPanel();
        JLabel lblSearchIconUser = new JLabel();
        ...
        btnHome.setIcon(new javax.swing.ImageIcon(Objects.requireNonNull(getClass().getResource("/Home.png")))); // NOI18N
        ...
        btnPayment.setIcon(new javax.swing.ImageIcon(Objects.requireNonNull(getClass().getResource("/Cash.png")))); // NOI18N
        ...
        btnRelatorio.setIcon(new javax.swing.ImageIcon(Objects.requireNonNull(getClass().getResource("/Analyze.png")))); // NOI18N
        ...
        btnSubscriber.setIcon(new javax.swing.ImageIcon(Objects.requireNonNull(getClass().getResource("/Tear-Off Calendar.png")))); // NOI18N
        ...
        btnSubscriber.addActionListener(this::btnSubscriberActionPerformed);

        btnUser.setBackground(new java.awt.Color(0, 57, 99));
        btnUser.setForeground(new java.awt.Color(255, 255, 255));
        btnUser.setIcon(new javax.swing.ImageIcon(Objects.requireNonNull(getClass().getResource("/Admin Settings Male.png")))); // NOI18N
        ...
        btnLogout.setIcon(new javax.swing.ImageIcon(Objects.requireNonNull(getClass().getResource("/Logout.png")))); // NOI18N
        ...
        lblTitle.setFont(new java.awt.Font("Segoe UI", Font.BOLD, 24)); // NOI18N
        ...
        txtVaga.setFont(new java.awt.Font("Segoe UI", Font.PLAIN, 14)); // NOI18N
        ...
        txtVaga.addActionListener(this::txtVagaActionPerformed);

        cBplace.setBackground(new java.awt.Color(255, 255, 255));
        cBplace.setFont(new java.awt.Font("Segoe UI", Font.PLAIN, 14)); // NOI18N
        ...
        cBplace.addActionListener(this::cBplaceActionPerformed);

        lblEntrada.setBackground(new java.awt.Color(0, 133, 255));
        lblEntrada.setFont(new java.awt.Font("Segoe UI", Font.BOLD, 16)); // NOI18N
        lblEntrada.setForeground(new java.awt.Color(0, 133, 255));
        lblEntrada.setText("Entrada:");

        txtSaida.setBackground(new java.awt.Color(0, 133, 255));
        txtSaida.setFont(new java.awt.Font("Segoe UI", Font.BOLD, 16)); // NOI18N
        ...
        FieldNotes.setFont(new java.awt.Font("Segoe UI", Font.PLAIN, 14)); // NOI18N
        ...
        FieldNotes.addActionListener(this::FieldNotesActionPerformed);

        jLabel1.setBackground(new java.awt.Color(0, 0, 0));
        jLabel1.setFont(new java.awt.Font("Segoe UI", Font.BOLD, 10)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(0, 0, 0));
        jLabel1.setText("Placa:");

        jLabel2.setFont(new java.awt.Font("Segoe UI", Font.BOLD, 10)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(0, 0, 0));
        jLabel2.setText("Vaga:");

        jLabel7.setFont(new java.awt.Font("Segoe UI", Font.BOLD, 10)); // NOI18N
        ...
        txtPlaca.setFont(new java.awt.Font("Helvetica Neue", Font.PLAIN, 36)); // NOI18N
        ...
        txtCheckInTime.addActionListener(this::txtCheckInTimeActionPerformed);
        ...
        txtParkingFee.setFont(new java.awt.Font("Helvetica Neue", Font.PLAIN, 36)); // NOI18N
        ...
        txtFeeLabel.setFont(new java.awt.Font("Helvetica Neue", Font.PLAIN, 18)); // NOI18N
        ...
        lblCaixa.setFont(new java.awt.Font("Segoe UI", Font.BOLD, 24)); // NOI18N
        ...
        btnTotal.setFont(new java.awt.Font("Segoe UI", Font.BOLD, 24)); // NOI18N
        ...
        btnDinheiro.setFont(new java.awt.Font("Segoe UI", Font.BOLD, 24)); // NOI18N
        ...
        btnBaixarMensal.setFont(new java.awt.Font("Segoe UI", Font.BOLD, 24)); // NOI18N
        ...
        btnBaixarDiario.setFont(new java.awt.Font("Segoe UI", Font.BOLD, 24)); // NOI18N
        ...
        lblRelatorio.setFont(new java.awt.Font("Segoe UI", Font.BOLD, 24)); // NOI18N
        ...
        lblMensalista.setFont(new java.awt.Font("Segoe UI", Font.BOLD, 24)); // NOI18N
        ...
        lblSearchIcon.setIcon(new javax.swing.ImageIcon(Objects.requireNonNull(getClass().getResource("/Search.png")))); // NOI18N
        ...
        txtSearchSubscriber.setFont(new java.awt.Font("Segoe UI", Font.PLAIN, 14)); // NOI18N
        ...
        btnAddSubscriber.setFont(new java.awt.Font("Segoe UI", Font.BOLD, 14)); // NOI18N
        ...
        lblUser.setFont(new java.awt.Font("Segoe UI", Font.BOLD, 24)); // NOI18N
        ...
        lblSearchIconUser.setIcon(new javax.swing.ImageIcon(Objects.requireNonNull(getClass().getResource("/Search.png")))); // NOI18N
        ...
        txtSearchUser.setFont(new java.awt.Font("Segoe UI", Font.PLAIN, 14)); // NOI18N
        ...
        btnAddUser.setFont(new java.awt.Font("Segoe UI", Font.BOLD, 14)); // NOI18N
